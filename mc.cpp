...
/* Constructor. -------------------------------------------------------------------*/
mc::mc(int iterations_in, int nt_in, double dt_in, bool verbose_in)
{
    /* Local variables. -----------------------------------------------------------*/
    double *duxi, *duyi, *duzi; /* Seismogram derivatives. */
    double *duxj, *duyj, *duzj; /* Seismogram derivatives. */
